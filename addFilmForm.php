...
<body>
    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            <!-- Tabs Titles -->
            <h2 class="inactive underlineHover">Ajouter Film</h2>
            <!-- Update Form -->
            <form method="post" action="asset/db/addFilmAdmin.php">
                ...
                <input type="submit" class="fadeIn fourth" value="Ajouter film">
            </form>
